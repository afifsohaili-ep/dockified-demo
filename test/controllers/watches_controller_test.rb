...
class WatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watch" do
    assert_difference('Watch.count') do
      post watches_url, params: { watch: { document_id: @watch.document_id, user_id: @watch.user_id } }
    end
  ...
  test "should update watch" do
    patch watch_url(@watch), params: { watch: { document_id: @watch.document_id, user_id: @watch.user_id } }
